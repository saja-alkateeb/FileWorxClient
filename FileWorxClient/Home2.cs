...
namespace FileWorxClient
{
    public partial class Home2 : Form
    {
       ...
       public void PopulateListView()
       {
        ...
        {
            int splitterDistance = (int)(splitContainer1.Panel2.Height * (1.0 / 3.0));
        ...
        private void logiToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void Home2_FormClosed_1(object sender, FormClosedEventArgs e)
        {
